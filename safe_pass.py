...
def decrypt_password(encrypted_password, key):
    try:
        ...
        return "Error: The key for the password is invalid or missing."
    ...
    try:
        with open(PASSWORD_FILE, 'r') as file:
            ...
            if encrypted_password:
                ...
                if password != "Error: The key for the password is invalid or missing.":
                	print(f"Password for {account}: {password}")
                else:
                    print("Error: The key for the password is invalid or missing.")
            else:
